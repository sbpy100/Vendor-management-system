...
class BillClass:
    def __init__(self,root):
        ...
        tilte_frame1.place(x=0,y=0,width=1350,height=95)
        ...
        # button logout---
        btn_logout=Button(tilte_frame1,text="Log-Out",command=self.log_out,font=("times new roman",15,"bold"),bg="red",cursor="hand2").place(x=1200,y=10,height=40,width=120)
        #==Product frame===
        ...
        lbl_search=Label(Productframe2,text="Product Name",font=("times new roman",15,"bold"),bg="white").place(x=5,y=80)
        txt_search=Entry(Productframe2,textvariable=self.var_search,font=("times new roman",15,"bold"),bg="lightyellow").place(x=129,y=82,width=150,height=22)
        btn_search=Button(Productframe2,text="Search",command=self.search,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=284,y=82,width=100,height=25)
        ...
        Productframe3.place(x=2,y=160,width=398,height=350)
        ...
        lbl_contact=Label(Customerframe,text="Contact",font=("times new roman",15,"bold"),bg="white").place(x=275,y=35)
        txt_contact=Entry(Customerframe,textvariable=self.var_contact,font=("times new roman",13,"bold"),bg="lightyellow").place(x=360,y=35,width=145)
        ...
        txt_p_qty=Entry(add_Cartframe,textvariable=self.var_qty,font=("times new roman",15),bg="lightyellow").place(x=390,y=35,width=120,height=22)
        ...
        btn_addcart=Button(add_Cartframe,text="Add | Update Cart",command=self.add_update_cart,font=("goudy old style",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)
        ...
        lbl_dealer=Label(Productframe2,text="Select Dealer",font=("goudy old style",15,"bold"),bg="white",fg="blue").place(x=5,y=45)
        ...
        self.cmb_deal.place(x=129,y=47,width=150,height=25)
        ...
        self.cmb_suppl.place(x=40,y=36,width=170,height=28)
        ...
        btn_clear=Button(Productframe2,text="Proceed",command=self.select_dealer,font=("goudy old style",15,"bold"),bg="lightgray",cursor="hand2").place(x=284,y=45,width=100,height=25)
    ...
    #=========================
        ...
        btn_order.place(x=246,y=80,width=160,height=50)
...
#=====================All Functions=============================================
    ...
    def fetch_dealer(self):
        ...
        cur=con.cursor()
        try:
            cur.execute("SELECT name from dealer  where name LIKE '%'")
            cat=cur.fetchall()
            if len(cat)>0:
    ...
    def add_update_cart(self):
        if self.cmb_deal.get()=='Select':
            messagebox.showerror("Error","Please Firstly Select the Dealer !!",parent=self.root)
    ...
    def generate_bill(self):
        ...
        elif self.cmb_suppl.get()=='Select':
