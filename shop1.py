...
class searchclass:
    def __init__(self,root):
        ...
        title=Label(self.root,text=" नमस्ते ! \nWelcome to the Technical Era of Dropshipping\nHope You will Enjoying a Lot",font=("goudy old style",25,"bold"),bg="blue",fg="yellow").place(x=380,y=40)
        title=Label(self.root,text="If you have any suggestions regarding imporvement then please let share with us\nयदि आपके पास सुधार के संबंध में कोई सुझाव है तो कृपया हमारे साथ साझा करें :-",font=("goudy old style",15,"bold"),bg="blue",fg="yellow").place(x=230,y=600)

        self.menulogo=Image.open("Images/fti.png")
        self.menulogo=self.menulogo.resize((200,40),Image.ANTIALIAS)
        self.menulogo=ImageTk.PhotoImage(self.menulogo)

        lbl_menulogo=Label(self.root,image=self.menulogo,bg="blue")
        lbl_menulogo.place(x=900,y=610)


        self.logo=Image.open("Images/category.jpg")
        self.logo=self.logo.resize((500,300),Image.ANTIALIAS)
        ...
        btn_cancel=Button(self.root,text="[] [] [] रद्द करें / Destroy Page =>",command=self.cancel,bg="blue",font=("times new roman",15,"italic","bold"),bd=0,cursor="hand2",fg="white").place(x=1050,y=10,width=280,height=40)
