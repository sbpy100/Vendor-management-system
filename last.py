...
class SMS:
    def __init__(self,root):
        ...
        # button logout---
        btn_logout=Button(self.root,command=self.log_out,text="Log-Out",font=("times new roman",15,"bold"),bg="red",cursor="hand2").place(x=1150,y=10,height=50,width=150)
        #clock---
        ...
        Leftmenu.place(x=0,y=102,width=200,height=525)
        ...
        # footer----
        lbl_footer=Label(self.root,text="SMS-Shop Management System | Developed by SSMSP\tFor any technical issue contact at Nexustech54@gmail.com",font=("times new roman",13),bg="#4d636d",fg="white").place(x=0,y=620,width=1350,height=70)
